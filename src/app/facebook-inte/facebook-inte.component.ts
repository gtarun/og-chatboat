...
connectPage(item, i){
  ...
  let urlS="https://graph.facebook.com/"+this.pageId+"/subscriptions?object=page&callback_url=https://og-chatbot-api.herokuapp.com/userwebhook&fields=messages&verify_token=outgrow_messanger_bot_verify_code_user&access_token=792069617611842|vuCRMvbZcZhv0OslCzkpoTgCUqQ";
